...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.totalEachItem.setText(String.format("$%d", Math.round((listFoodSelected.get(position).getNumberInCart() * listFoodSelected.get(position).getFee()))));
        holder.num.setText(String.valueOf(listFoodSelected.get(position).getNumberInCart()));

        // System.out.println("PIC URL" + listFoodSelected.get(position).getPic());
        ...
        holder.plusItem.setOnClickListener(view -> managementClass.plusNumberFood(listFoodSelected, position, () -> {
            notifyDataSetChanged();
            changeNumberItemsListener.changed();
        }));

        holder.minusItem.setOnClickListener(view -> managementClass.minusNumberFood(listFoodSelected, position, () -> {
            notifyDataSetChanged();
            changeNumberItemsListener.changed();
        }));
...
//            intent.putExtra("object", String.valueOf(listFoodSelected.get(position)));
...
//                managementClass.plusNumberFood(listFoodSelected, position, new ChangeNumberItemsListener() {
//                    @Override
//                    public void changed() {
//                        notifyDataSetChanged();
//                        changeNumberItemsListener.changed();
...
//            @Override
//            public void onClick(View view) {
//                managementClass.minusNumberFood(listFoodSelected, position, new ChangeNumberItemsListener() {
//                    @Override
//                    public void changed() {
//                        notifyDataSetChanged();
//                        changeNumberItemsListener.changed();
